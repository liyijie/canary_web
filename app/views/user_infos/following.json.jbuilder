...
json.user_infos(@users) do |user|
  ...
  json.image_thumb image_url(user.user_info.avatar.url(:thumb)) if user.user_info.avatar
  json.image_large image_url(user.user_info.avatar.url(:medium)) if user.user_info.avatar
end
